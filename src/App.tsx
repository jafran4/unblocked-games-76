      ...
      <nav className="sticky top-0 z-50 px-6 py-4 mx-4 mt-4 glass rounded-2xl border border-black/10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2 text-black/20">
            ...
            <Search size={18} className="cursor-pointer hover:text-brand-purple transition-colors" />
          </div>
        </div>
      </nav>
            ...
            <div className="space-y-12">
              ...
              <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                >
                  ...
                  <button className="w-full py-3 mt-2 glass rounded-xl text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-slate-900 hover:bg-black/10 transition-all">
                    Explore More
                  </button>
                </motion.div>
              </section>
              ...
              <section className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button className="text-sm text-slate-500 hover:text-brand-purple flex items-center gap-1 transition-colors">
